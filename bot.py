...
def parse_post_text(text):
    ...
    for l in lines:
        ...
        if "كود" in cl:
            d = re.findall(r'\d+', l)
            if d: code = f" (كود {d[0]})"
        if any(k in cl for k in ["اسم الموديل", "برا", "اندر", "هاف", "شراب", "بجامه", "بيجامه", "بنطلون", "طقم", "عبايه", "كاش", "ترنج", "فستان", "شورت", "قميص", "كوليكشن", "سوكت", "موديل", "ماركه", "ماركة"]):
