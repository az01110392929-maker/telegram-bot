...
def main():
    ...
    app.add_handler(CallbackQueryHandler(CallbackQueryHandler(clear_cart, pattern="^clear_cart$") if False else clear_cart, pattern="^clear_cart$")) # تم ضبطه ليعمل بسلاسة
